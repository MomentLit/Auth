...
Service context: Auth uses `com.example.auth` and currently has this responsibility: No visible controller endpoints or domain use cases are implemented yet.
